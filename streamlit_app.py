...
API_URL = "https://h-a-pred.onrender.com/predict/"
...
if submit_button:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.write(f"**Prediction:** {'Heart Attack Risk' if result.get('prediction') == 1 else 'No Risk'}")
            st.write(f"**Probability:** {result.get('probability')}")
        else:
